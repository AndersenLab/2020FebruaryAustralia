...
```{r, echo=F, warning = F, message=F}
# load fulcrum data
load('data/fulcrum/2020FebruaryAustralia_fulcrum.Rda')

fulcrum_dat <- `2020FebruaryAustralia_fulcrum`
rm(`2020FebruaryAustralia_fulcrum`)
#################################################
### set color palettes                        ###
#################################################
...
target_map
```
<br> <font color="darkred">*Red points*</font> are C. elegans.
